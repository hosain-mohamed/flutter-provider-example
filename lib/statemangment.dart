...
//tips : 
  - put consumer deep in the widget tree to abvoid rebuild large part of UI
 	- tips :  Just learn how to use ChangeNotifierProvider and Consumer. Every now and then you might use a Provider
     widget if you don’t need to update the UI. Most of the time you won’t need a MultiProvider either if you have a
     view model for each screen or page 
